...
To let ArgoCD manage and deploy our ProviderConfig we again create a new ArgoCD Application CRD at [argocd/crossplane-bootstrap/crossplane-provider-azure-config.yaml](https://github.com/adamschnaider/azure-argocd-crossplane/blob/main/argocd/crossplane-bootstrap/crossplane-provider-azure-config.yaml):
